  ...
  <div id="container">
    <div class="container">
      ...
      <ul class="breadcrumb">
        ...
        <li><a href="index.php?c=user&a=register">حساب کاربری</a></li>
        ...
        <div id="content" class="col-sm-9">
          ...
          <div class="row">
            <div class="col-sm-6">
              ...
              <a href="index.php?c=user&a=register" class="btn btn-primary">ادامه</a> </div>
            <div class="col-sm-6">
              ...
              <form action="index.php?c=user&a=login" method="POST">
                <div class="form-group">
                  ...
                  <input type="text" name="data[email]" value="" placeholder="آدرس ایمیل" id="input-email" class="form-control" />
                </div>
                <div class="form-group">
                  <label class="control-label" for="input-password">رمز عبور</label>
                  <input type="password" name="data[password]" value="" placeholder="رمز عبور" id="input-password" class="form-control" />
                  <br />
