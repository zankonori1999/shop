            ...
            <div class="col-sm-4">
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h4 class="panel-title"><i class="fa fa-sign-in"></i> ایجاد حساب کاربری یا ورود</h4>
                </div>
                          ...
                          <table class="table table-bordered">
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    $val = $basket->select_pro($list->procat_id);
                                ?>
                              <tr>
                                <td class="text-center"><a href="index.php?c=pro&a=details&id=<?php echo $list->procat_id; ?>"><img src="<?php echo $val['img1']; ?>" alt="<?php echo $val['title']; ?>" title="<?php echo $val['title']; ?>" class="img-thumbnail"></a></td>
                                <td class="text-left"><a href="index.php?c=pro&a=details&id=<?php echo $list->procat_id; ?>"><?php echo $val['title']; ?></a></td>
                                ...
                                <td class="text-right"><?php echo $val['price']; ?> تومان</td>
                                <td class="text-right"><?php echo $val['price']*$list->count; $tt += $val['price']*$list->count;  ?> تومان</td>
                              </tr>
                                <?php endforeach; ?>
                            </tbody>
                            <tfoot>
                              <tr>
                                ...
                                <td class="text-right"><?php echo $tt; ?> تومان</td>
                              </tr>
                              <tr>
