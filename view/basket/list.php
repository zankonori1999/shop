  ...
  <div id="container">
    <div class="container">
      ...
      <ul class="breadcrumb">
        ...
        <li><a href="index.php?c=basket&a=list">سبد خرید</a></li>
      </ul>
      <!-- Breadcrumb End-->
      <div class="row">
        <!--Middle Part Start-->
        <div id="content" class="col-sm-12">
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                    <?php
                            ...
                            $pro = $basket->select_pro($list->procat_id);
                    ?>
                        
                  <tr>
                    <td class="text-center"><a href="index.php?c=pro&a=details&id=<?php echo $list->procat_id;?>"><img src="<?php echo $pro['img1']; ?>" alt="<?php echo $pro['title']; ?>" title="<?php echo $pro['title'];?>" class="img-thumbnail" /></a></td>
                    <td class="text-left"><a href="index.php?c=pro&a=details&id=<?php echo $list->procat_id;?>"><?php echo $pro['title']; ?></a><br />
                    ...
                    <td class="text-right"><?php echo $pro['price']; ?> تومان</td>
                    <td class="text-right"><?php echo $pro['price']*$list->count; $total += $pro['price']*$list->count;  ?> تومان</td>
                  </tr>
                    <?php endforeach; ?>
                </tbody>
              </table>
          ...
          <div class="buttons">
            <div class="pull-left"><a href="index.php?c=index&a=index" class="btn btn-default">ادامه خرید</a></div>
            <div class="pull-right"><a href="index.php?c=basket&a=details" class="btn btn-primary">تسویه حساب</a></div>
          </div>
        </div>
        <!--Middle Part End -->
      </div>
